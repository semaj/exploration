...
describe Node do
  ...
  describe '#rotate_up' do
    ...
    it 'c should rotate up once' do
      @dclone = @d.clone
      @dclone.left = Node.new(@dclone, :c, 91)
  ...
  describe '#insert' do
    ...
    it 'should be match correct structure' do
      @d = Node.root(:d, 100)
      @d.left = Node.new(@d, :c, 91)
      @d.right = Node.new(@d, :e, 80)
      @d.left.left = Node.new(@d.left, :b, 90)
      @d.left.left.left = Node.new(@d.left.left, :a, 70)
      @t.inorder_valus.must_equal @d.inorder_valus
    end

    it 'should be valid heap' do
      @t.valid_heap?.must_equal true
    end
  end
  ...
  describe '#delete' do
    ...
    it 'should delete c correctly' do
      @d = Node.root(:d, 100)
      @b = Node.new(@d, :b, 90)
      @e = Node.new(@d, :e, 80)
      @d.right = @e
